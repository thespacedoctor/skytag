...
html_theme_options = {
    ...
    'github_repo': 'skytag',
    'strap_line': "Annotate transient sources or galaxies with the percentage credibility region they reside within on a given HealPix sky map."
}
...
""" % locals()
link_resolver_url = "https://github.com/thespacedoctor/skytag/tree/master"
...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/skytag.rst']
modindex_common_prefix = ["skytag."]

# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'skytag.tex', u'skytag Documentation',
     u'Dave Young', 'manual'),
]
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["skytag"]
    allSubpackages += findAllSubpackges(
        pathToPackage="skytag"
    )
